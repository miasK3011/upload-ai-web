    ...
    <div className='min-h-screen flex flex-col'>
      <div className="px-6 py-3 flex items-center justify-between border-b">
        ...
        <div className="flex items-center gap-3">
          <span className="text-sm text-muted-foreground">Desenvolvido com ❤ by Mias</span>
        ...
        <aside className='w-80 space-y-6'>
          ...
          <form onSubmit={handleSubmit} className='w-80 space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <span className='block text-xs text-muted-foreground italic leading-relax space-y-4'>
